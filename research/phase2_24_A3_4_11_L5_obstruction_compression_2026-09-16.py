...
# 1. Construct L5 inside the degree-5 tensor algebra.
L5_candidates = []
...
# 2. Build the L5 coordinate extractor once.
...
# 3. Compress A3-4-10 obstruction to L5.
...
# 5. Local degree-5 relation span. R4_matrix has 6 displayed generators
#    but rank 5; select an actual independent basis before bracketing.
...
assert R4_ind.shape == (256, 5)
assert rank3(R4_ind) == 5
...
print('RESULT: the degree-5 obstruction is an actual L5-valued obstruction; compression to L5 loses no rank.')
